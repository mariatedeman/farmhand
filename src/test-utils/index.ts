...
export const testCrop = (item: any = {}): farmhand.plotContent => ({
  daysOld: 0,
  daysWatered: 0,
  fertilizerType: fertilizerType.NONE as fertilizerType,
...
export const testState = (
  ...
  toolLevels: {
    AXE: toolLevel.UNAVAILABLE as toolLevel,
    HOE: toolLevel.DEFAULT as toolLevel,
    PICKER_POLE: toolLevel.UNAVAILABLE as toolLevel,
    SCYTHE: toolLevel.DEFAULT as toolLevel,
    SHOVEL: toolLevel.UNAVAILABLE as toolLevel,
    WATERING_CAN: toolLevel.DEFAULT as toolLevel,
  },
